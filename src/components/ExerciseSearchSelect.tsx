            ...
            <CommandList>
              <CommandEmpty>
                <div className="text-center py-2">
                  ...
                  <Button size="sm" variant="outline" className="text-xs" onClick={() => { setOpen(false); setCreateOpen(true); }}>
                    <Plus className="h-3 w-3 mr-1" />Crear ejercicio
                  </Button>
                </div>
              </CommandEmpty>
              {predefined.length > 0 && (
              ...
              <CommandGroup>
                <CommandItem value="__create__" onSelect={() => { setOpen(false); setCreateOpen(true); }}>
                  ...
                  <span className="text-primary font-medium">Crear nuevo ejercicio</span>
                </CommandItem>
              </CommandGroup>
            </CommandList>
          </Command>
